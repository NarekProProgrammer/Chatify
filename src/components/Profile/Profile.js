...
import { updateSetting } from '../store/slices/userInfoSlice';
			...
			<div className="all-info-column">
				...
				<div className="basic-info-column">
					<div className="info-item" >
						...
						{editingFirstName ?
							<div>
								<input className="input input-editName" type="text" value={userInfo.firstName} onChange={onClickEditName} />
								<button className="btn btn-save" onClick={() => { setEditingFirstName(false) }}><img src="/icon-save.png" /></button>
							</div>
							: <div className="">
								<p className="user-info">{userInfo.firstName}</p>
								<button className="btn btn-edit" onClick={() => { setEditingFirstName(true) }}><img src="/icon-edit.png" /></button>
							</div>}
					</div>
					<div className="info-item">
						...
						{editingLastName ?
							<div>
								<input className="input input-editName" type="text" value={userInfo.lastName} onChange={onClickEditLastName} />
								<button className="btn btn-save" onClick={() => { setEditingLastName(false) }}><img src="/icon-save.png" /></button>
							</div> : <div>
								<p className="user-info">{userInfo.lastName}</p>
								<button className="btn btn-edit" onClick={() => { setEditingLastName(true) }}><img src="/icon-edit.png" /></button>
							</div>}
					</div>
					<div className="info-item">
						...
						{editingDateOfBirth ?
							<div>
								...
								<button className="btn btn-save" onClick={() => { setEditingDateOfBirth(false) }}><img src="/icon-save.png" /></button>
							</div> : <div>
								<p className="user-info">{userInfo.dateOfBirth}</p>
								<button className="btn btn-edit" onClick={() => { setEditingDateOfBirth(true) }}><img src="/icon-edit.png" /></button>
							</div>}
					</div>
					<div className="info-item">
						...
						{editingFloor ?
							<div>
								{/* <input className="input input-editDateOfBirth" type="text" value={userInfo.dateOfBirth} onChange={onClickEditDateOfBirth} /> */}
								<select name="floor" id="floor" value={userInfo.floor} onChange={onClickEditFloor}>
									<option value="male">Male</option>
									<option value="female">Female</option>
								</select>
								<button className="btn btn-save" onClick={() => { setEditingFloor(false) }}><img src="/icon-save.png" /></button>
							</div> : <div>
								<p className="user-info">{userInfo.floor}</p>
								<button className="btn btn-edit" onClick={() => { setEditingFloor(true) }}><img src="/icon-edit.png" /></button>
							</div>}
					</div>
				</div>
				{/* Contact Information */}
				...
				<div className="personal-info-column">
					<div className="info-item">
						...
						{editingEmail ?
							<div>
								<input className="input input-editEmail" type="text" value={userInfo.email} onChange={onClickEditEmail} />
								<button className="btn btn-save" onClick={() => { setEditingEmail(false) }}><img src="/icon-save.png" /></button>
							</div> : <div>
								<p className="user-info">{userInfo.email}</p>
								<button className="btn btn-edit" onClick={() => { setEditingEmail(true) }}><img src="/icon-edit.png" /></button>
							</div>}
					</div>
					<div className="info-item">
						...
						{editingPassword ?
							<div>
								<input className="input input-editPassword" type="password" value={userInfo.password} onChange={onClickEditPassword} />
								<button className="btn btn-save" onClick={() => { setEditingPassword(false) }}><img src="/icon-save.png" /></button>
							</div> : <div>
								<p className="user-info">{userInfo.password}</p>
								<button className="btn btn-edit" onClick={() => { setEditingPassword(true) }}><img src="/icon-edit.png" /></button>
							</div>}
					</div>
				</div>
			</div>
